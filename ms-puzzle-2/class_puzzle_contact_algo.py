    ...
    def SetAlgorithmInputs(self, inputPins, FailPin = None, ActiveLow = False):
        ...
        for individualPin in inputPins:
            if ActiveLow is False:
                tmpButtonObject = gpiozero.Button(individualPin, pull_up=False, bounce_time=0.1, hold_time=0.1)
            else:
                tmpButtonObject = gpiozero.Button(individualPin, pull_up=True, bounce_time=0.1, hold_time=0.1)
            #end if
        ...
        if FailPin is not None:
            if ActiveLow is False:
                tmpButtonObject = gpiozero.Button(FailPin, pull_up=False, bounce_time=0.1, hold_time=0.1)
            else:
                tmpButtonObject = gpiozero.Button(FailPin, pull_up=True, bounce_time=0.1, hold_time=0.1)
            #end if
